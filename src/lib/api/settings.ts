...
export type SettingsField = "contact" | "social" | "about" | "email"
...
export type CoreValueData = Record<string, string>
...
const JSON_FIELDS = new Set<SettingsField>(["contact", "social", "about", "email"])
